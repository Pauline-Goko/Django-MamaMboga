...
from .views import CustomerListView, CustomerDetailView, ProductListView, ProductDetailView, CartListView, CartDetailView, OrderListView, OrderDetailView, AddToCartView
